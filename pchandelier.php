<!DOCTYPE html>
    <html>
    <head>
    	<title>Category Chandelier - LightInTheHome - Global Online Shopping for Lightings</title>
    	<script src="./scripts/jquery-latest.js"></script>
    	<script src="http://code.jquery.com/jquery-latest.js"></script>
        <script src="./scripts/jquery.cycle.all.js"></script>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
        <link rel="stylesheet" type="text/css" href="./stylesheets/pchandelier.css">
    </head>
    <body>
       <div>
         ...
         <tr>
           ...
           <table>
             <tr>
                   ...
                   <td>
                     <h1>$110 Free Shipping Globally.</h1>
              ...
              <tr>
                   ...
                   <td>
                     <h1>$360 Free Shipping Globally.</h1>
                     <h2>Approximately 20 days to receive.</h2>
                     <div>
                     <form action="./cart.php" method="POST">
                         <h2>Qty</h2>
              ...
              <tr>
                   ...
                   <td>
                     <h1>$180 Free Shipping Globally.</h1>
                     <h2>Approximately 20 days to receive.</h2>
                     <div>
                     <form action="./cart.php" method="POST">
                         <h2>Qty</h2>
