...
if($_POST['update1']){
          ...
          $sql1 = "UPDATE customers SET username='$username2', password='$password2', name='$name2', DOB='$dob2', email='$email2', access='$access2' WHERE ID='$id2'";
            $result1 = mysqli_query($mysql,$sql1);
            header('Location: ./custupdate.php');
         }
session_start();
